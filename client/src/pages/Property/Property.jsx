...
const Property = () => {
  ...
  // Add mutation for removing residency
  const { mutate: deleteResidency, isLoading: deleting } = useMutation({
    ...
    onSuccess: () => {
      ...
      navigate("/properties"); // Redirect to properties page after removal
    },
    onError: () => {
      toast.error("Failed to remove property", { position: "bottom-right" });
    },
  });

  const handleRemoveProperty = () => {
    if (!isAuthenticated) {
      toast.error("You must be logged in to remove a property", {
        position: "bottom-right",
      });
      return;
    }
